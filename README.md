...
Демо: https://navcrm.opengluck.ru/  
Логин: **demo**, пароль: **demonavcrm**
...
- войдите (http://localhost — admin:admin)
...
- В демо версии нет разделения по ролям и логирования действий пользователей.
- В демо версии — одна организация и один пользователь.
